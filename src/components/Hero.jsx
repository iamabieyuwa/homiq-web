  ...
  return (
    <section className="relative h-screen overflow-hidden">
      ...
      <div className="relative z-10 h-full flex items-center justify-center text-center px-4 text-white">
        <div className="max-w-2xl w-full transform -translate-y-1/4">
          ...
          {/* Search Bar */}
          <div className="flex items-stretch justify-center gap-0 max-w-md mx-auto mt-6 shadow-2xl border-2 border-white rounded-full bg-white/80">
            <input
              type="text"
              placeholder="Search location or property..."
              className="w-full px-4 py-2.5 md:py-3 text-sm md:text-base rounded-l-full focus:outline-none bg-white text-black placeholder:text-black/60"
            />
