        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-6">
            {categories.map((cat, i) => (
              <div
                key={i}
                className="flex flex-col items-center justify-center bg-white dark:bg-black border border-black/10 dark:border-white/10 p-4 rounded-lg shadow-sm hover:shadow-md transition cursor-pointer"
              >
